...
(function($) {
    var NivoSlider = function(element, options){
        ...
        /**
         * SHATTER EFFECT  
         * Canvas vẽ ảnh cũ vỡ thành các mảnh bay ra, rồi hiện ảnh mới
         */
        var runShatter = function(slider, settings, vars, onComplete){
            ...
            oldImg.onload = function(){
                ...
                newImg.onload = function(){ requestAnimationFrame(drawShatter); };
                newImg.onerror = function(){ requestAnimationFrame(drawShatter); };
                newImg.src = newSrc;
            };
