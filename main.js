...
function firstQuestion(){
    ...
    $('#wrapper, header, #yes, #no, .inner-width, center, .demo, p,  span[id^="a"], #chaffle-title, #slider').hide();
    Swal.fire({
        ...
        $('#wrapper, header, #yes, #no, .inner-width, center, .demo, p,   span[id^="a"], #chaffle-title, #slider').show(200);
    })
}
