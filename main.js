...
function firstQuestion(){
    ...
    $('#wrapper, header, #yes, #no, .demo, .inner-width, center, p,  span[id^="a"], #chaffle-title').hide();
    Swal.fire({
        ...
        $('#wrapper, header, #yes, #no, .demo, .inner-width, center, p,   span[id^="a"], #chaffle-title').show(200);
      })
}
