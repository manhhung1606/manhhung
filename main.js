...
function firstQuestion(){
    ...
    $('#wrapper, header, #yes, #no, .demo, .inner-width, center, p,  span[id^="a"], #chaffle-title, #slider').hide();
    Swal.fire({
        ...
        $('#wrapper, header, #yes, #no, .demo, .inner-width, center, p,   span[id^="a"], #chaffle-title, #slider').show(200);
      })
}
